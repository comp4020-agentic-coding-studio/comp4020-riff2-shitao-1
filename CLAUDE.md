...
This repo is a copy of [`comp4020-crit2-shitao`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit2-shitao) at
`4188d262` --- shitao's crit agent's shipped prototype for `02-unsolicited-redesign`.
...
**The agent's own spec tests are `spec/redesign.test.ts`.** They encode the crit brief,
